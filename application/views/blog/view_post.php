<div class="site-cover site-cover-sm same-height overlay single-page" style="background-image: url('<?php echo base_url()?>public/images/img_2.jpg');">
    <div class="container">
        <div class="row same-height justify-content-center">
            <div class="col-md-12 col-lg-10">
                <div class="post-entry text-center">
                    <h1 class="mb-4"><a href="#"><?php echo $datablog['title']; ?></a></h1>
...
<section class="site-section py-lg" id="post_content">
    <div class="container">
        ...
        <div class="row blog-entries element-animate">
            ...
            <div class="col-md-12 col-lg-8 main-content">
                ...
                <div class="post-content-body">
                    <p><?php echo $datablog['content']; ?></p>
					<p><?php echo $datablog['content']; ?></p>
                    <div class="row mb-5 mt-5">
                        <div class="col-md-12 mb-4">
                            <img src="<?php echo base_url()?>public/images/img_1.jpg" alt="Image placeholder" class="img-fluid rounded">
                        </div>
                        <div class="col-md-6 mb-4">
                            <img src="<?php echo base_url()?>public/images/img_2.jpg" alt="Image placeholder" class="img-fluid rounded">
                        </div>
                        <div class="col-md-6 mb-4">
                            <img src="<?php echo base_url()?>public/images/img_3.jpg" alt="Image placeholder" class="img-fluid rounded">
                        </div>
                    </div>
